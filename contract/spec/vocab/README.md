...
Current entries (all 0.1.0 except `transport/reasoning_tags` 0.3.0 , `format/scaled_number`, `format/table` and `reader/json_object` 0.2.0, provided by `python/lmcc_std`):
