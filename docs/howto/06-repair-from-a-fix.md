...
entry = {
    "name": "x", "versions": {"kernel": "0.5.0", "vocab": {}},
    "template": [
...
try:
    ...
    assert r.describe() == {
        ...
        "hint": "kernel: artifact needs 0.9.0, this implementation provides 0.5.0",
        "fix": {"action": "match-version", "entry": "kernel", "needs": "0.9.0", "provides": "0.5.0"},
        "partial": None}
```
