...
func Install(reg *lmcc.Registry) error {
	steps := []func() error{
		...
		func() error { return reg.RegisterFormat("code_arguments", newCodeArguments, Version, true) },
		func() error { return reg.RegisterFormat("code_calls", newCodeCalls, Version, true) },
		func() error { return reg.RegisterStrategy("heredoc_tools", heredocTools, Version, true) },
